...
interface ICurveRegistry {
    /**
     * @notice Returns `Curve Pool` addres for given `Curve LP Token`.
    ...
    /**
     * @notice Returns `Curve Pool` for given `LP Token`.
     ...
     */
    // solhint-disable-next-line func-name-mixedcase, var-name-mixedcase
    function pool_list(uint256 poolIndex) external view returns (address);
     ...
     * @return address The address of the coin.
     */
    // solhint-disable-next-line func-name-mixedcase, var-name-mixedcase
    function get_coin(uint256 coinIndex) external view returns (address);
}
