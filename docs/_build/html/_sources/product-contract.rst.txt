...
* cancelPolicy(): policy contracts can make this call to cancel the policy and get a prorated refund minus cancelation fee, will make a mutative call back to policy contract to kill it
