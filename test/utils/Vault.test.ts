...
import { Vault, Weth9, Registry, PolicyManager, RiskManager, MockProductV2, CoverageDataProvider, RiskStrategy, MockRiskStrategy, ProductFactory } from "../../typechain";
...
//   let claimsEscrow: ClaimsEscrow;
  ...
  describe("deployment", function () {
    ...
    it("reverts if zero weth", async function () {
      ...
      await expect(deployContract(owner, artifacts.Vault, [owner.address, registry2.address])).to.be.revertedWith("key not in mapping");
    });
  });
