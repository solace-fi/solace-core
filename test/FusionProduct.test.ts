...
import { PolicyManager, Treasury, Weth9, ClaimsEscrow, Registry, Vault, RiskManager, MockProduct, AaveV2Product, CompoundProduct, CurveProduct, YearnV2Product, FusionProduct } from "../typechain";
...
const DOMAIN_NAME = "Solace.fi-FusionProduct";
const INVALID_DOMAIN = "Solace.fi-Invalid";
const SUBMIT_CLAIM_TYPEHASH = utils.keccak256(utils.toUtf8Bytes("FusionProductSubmitClaim(uint256 policyID,address claimant,uint256 amountOut,uint256 deadline)"));
