...
describe("Governance", function() {
  ...
  describe("transfer", function () {
    ...
    it("rejects governance transfer by non governor", async function() {
      ...
      await expect(solace.connect(zero_user).acceptGovernance()).to.be.revertedWith("!governance");
      await expect(solace.connect(max_user).acceptGovernance()).to.be.revertedWith("!governance");
    });
