...
interface YearnV2ProductInterface extends ethers.utils.Interface {
  functions: {
  ...
  encodeFunctionData(functionFragment: "yregistry", values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: "yregistry", data: BytesLike): Result;
...
export class YearnV2Product extends Contract {
  ...
  interface: YearnV2ProductInterface;
  ...
  yregistry(overrides?: CallOverrides): Promise<string>;
  ...
  estimateGas: {
    ...
    yregistry(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    yregistry(overrides?: CallOverrides): Promise<PopulatedTransaction>;
