...
const MESSAGE_BUS_ADDRESS                    = ""; // not deployed on kovan
const COVERAGE_DATA_PROVIDER_WRAPPER_ADDRESS = "0x501Acef201B7Ad6FFe86A37d83df757454924aD5"; // not deployed on kovan
