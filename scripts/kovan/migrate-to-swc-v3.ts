...
const MULTICALL_ADDRESS               = "0x2cc8688c5f75e365aaeeb4ea8d6a480405a48d2a";
...
async function fetchPolicies() {
  ...
  fs.writeFileSync('./stash/data/kovan/policies.json', res);
  console.log(res);
}

async function mintScp() {
  let policies = JSON.parse(fs.readFileSync('./stash/data/kovan/policies.json').toString());
