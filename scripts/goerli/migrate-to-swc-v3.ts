...
const MULTICALL_ADDRESS               = "0x77dca2c955b15e9de4dbbcf1246b4b85b651e50e";
...
async function fetchPolicies() {
  ...
  fs.writeFileSync('./stash/data/goerli/policies.json', res);
  console.log(res);
}

async function mintScp() {
  let policies = JSON.parse(fs.readFileSync('./stash/data/goerli/policies.json').toString());
