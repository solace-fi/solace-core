...
import { Deployer, Registry, Weth9, Vault, ClaimsEscrow, Treasury, PolicyManager, PolicyDescriptor, RiskManager, OptionsFarming, FarmController, CpFarm, SptFarm, Solace, CompoundProductRinkeby, WaaveProduct, LiquityProduct } from "../typechain";
